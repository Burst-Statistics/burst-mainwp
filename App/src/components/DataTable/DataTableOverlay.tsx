...
const VARIANT_META: Record<string, { label: string; icon: string }> = {
	pages: { label: __( 'Pages', 'burst-mainwp' ), icon: 'page' },
	referrers: { label: __( 'Referrers', 'burst-mainwp' ), icon: 'referrer' },
	countries: { label: __( 'Locations', 'burst-mainwp' ), icon: 'world' },
	campaigns: { label: __( 'Campaigns', 'burst-mainwp' ), icon: 'campaign' },
	...
	not_found_pages: { label: __( '404 Pages', 'burst-mainwp' ), icon: 'page' },
										...
										{ showDropdown ? (
											...
											>
												<Select.Trigger
													...
													aria-label={ __( 'Select Variant', 'burst-mainwp' ) }
												>
													<Icon
