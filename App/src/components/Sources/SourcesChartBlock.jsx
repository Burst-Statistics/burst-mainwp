...
const SOURCE_LABELS = {
	search: __( 'Search', 'burst-mainwp' ),
	social: __( 'Social', 'burst-mainwp' ),
	referral: __( 'Referral', 'burst-mainwp' ),
	aiReferral: __( 'AI referral', 'burst-mainwp' ),
	paid: __( 'Paid', 'burst-mainwp' ),
	direct: __( 'Direct / unknown', 'burst-mainwp' )
};
...
const ALL_SOURCE_DEFINITIONS = [
	...
	{ key: 'email', label: __( 'Email', 'burst-mainwp' ), color: 'var(--color-green-400)' },
			...
			<table className="w-full border-collapse text-sm">
				<thead>
					<tr className="border-b border-gray-200 text-xs text-gray-600">
						...
						<th className="pb-1.5 text-right font-medium">{ __( 'Visits', 'burst-mainwp' ) }</th>
