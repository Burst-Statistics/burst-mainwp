		...
		return (
			...
			>
				<div className="w-full flex flex-col gap-5 px-6">
					...
					<div className="flex items-center justify-between gap-4">
						<div className="flex flex-col gap-1">
							<span className="text-md font-medium text-text-black">
								{ __( 'Share anonymous usage data', 'burst-mainwp' ) }
							</span>
					...
					<div className="grid gap-4 @sm:grid-cols-2">
						...
						<div className="flex flex-col gap-2 rounded-lg border border-gray-200 bg-gray-50 p-4">
							<h4 className="flex items-center gap-2 text-sm font-semibold text-text-black">
								...
								{ __( 'What we collect', 'burst-mainwp' ) }
							</h4>
							<ul className="flex flex-col gap-1.5 text-sm text-text-gray">
								<li className="flex items-start gap-2">
									...
									{ __( 'General site metrics (e.g., monthly visitors, bounce rate)', 'burst-mainwp' ) }
								</li>
								<li className="flex items-start gap-2">
									<span className="mt-1.5 h-1 w-1 shrink-0 rounded-full bg-gray-400"></span>
									{ __( 'Active plugins & WordPress/PHP versions', 'burst-mainwp' ) }
								</li>
								<li className="flex items-start gap-2">
									<span className="mt-1.5 h-1 w-1 shrink-0 rounded-full bg-gray-400"></span>
									{ __( 'Burst settings you use', 'burst-mainwp' ) }
								</li>
							</ul>
						</div>
						...
						<div className="flex flex-col gap-2 rounded-lg border border-gray-200 bg-gray-50 p-4">
							<h4 className="flex items-center gap-2 text-sm font-semibold text-text-black">
								...
								{ __( 'What we never collect', 'burst-mainwp' ) }
							</h4>
							<ul className="flex flex-col gap-1.5 text-sm text-text-gray">
								<li className="flex items-start gap-2">
									<span className="mt-1.5 h-1 w-1 shrink-0 rounded-full bg-gray-400"></span>
									{ __( 'Your site URL, admin emails, or user data', 'burst-mainwp' ) }
								</li>
								<li className="flex items-start gap-2">
									<span className="mt-1.5 h-1 w-1 shrink-0 rounded-full bg-gray-400"></span>
									{ __( 'Visitor IP addresses or specific page URLs', 'burst-mainwp' ) }
								</li>
							</ul>
						</div>
					</div>
					...
					>
						{ __( 'Learn more about how we handle data', 'burst-mainwp' ) }
