...
export const LivePreview = () => {
	...
	return (
		<div data-tour="wizard-preview" className="relative flex flex-col items-stretch justify-stretch dark:bg-gray-50 bg-wp-gray rounded-t-2xl flex-auto border border-b-0 border-gray-400 mr-4 lg:mr-8 max-lg:mx-4 overflow-hidden group/root shadow-layered-low-b h-full">
			...
			<div className="py-4 px-6 z-1 w-full flex items-center justify-between shadow-layered-low-b bg-gray-50">
				<p className='text-text-gray-light text-sm font-semibold uppercase tracking-[0.05em]'>
					{isEditingMode ? __( 'Editor', 'burst-mainwp' ) : __( 'Live preview', 'burst-mainwp' )}
				</p>
			</div>
