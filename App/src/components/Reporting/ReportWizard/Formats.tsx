...
export const Formats = () => {
	...
	return (
		<div data-tour="wizard-formats">
			<FieldWrapper
				label={__( 'Choose the report format', 'burst-mainwp' )}
				inputId="report-format"
				help={__( 'The classic format will be sent as an email. This does not allow much customization and is best suited for a quick regular update on your websites performance. The story format will create an shareable page on this website. This allows for more customization and allows you to create a fully custom report that can be shared with your team or clients. This report can also be downloaded as a PDF file.', 'burst-mainwp' )}
				context={__( 'A classic report will be sent by the email. A story report will create a report on this website, which you can choose to share with your team or clients.', 'burst-mainwp' ) }
			>
