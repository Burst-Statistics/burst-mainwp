...
const ACTION_INSTRUCTION: Partial<Record<TourStepAction, string>> = {
	click_element: __( 'Click the highlighted element to continue.', 'burst-mainwp' ),
	open_modal: __( 'Click the highlighted button to open it.', 'burst-mainwp' ),
	hover_element: __( 'Hover over the highlighted element.', 'burst-mainwp' ),
	click_tab: __( 'Click the highlighted tab above to continue.', 'burst-mainwp' ),
	change_date_range: __( 'Select "All time" from the date range dropdown to continue.', 'burst-mainwp' ),
	change_metrics: __( 'Select any metric and click Apply to update the graph.', 'burst-mainwp' ),
	apply_filter: __( 'Click + Add filter and apply a filter to continue.', 'burst-mainwp' ),
	toggle_columns: __( 'Toggle any column and click Apply to customize the table.', 'burst-mainwp' ),
	generate_share_link: __( 'Click "Generate shareable link" to create a live share link.', 'burst-mainwp' )
};
			...
			<div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
				...
				{ action && ACTION_INSTRUCTION[ action ] && (
					...
					>
						<span>
							{ interactionComplete ?
								'✅ ' + __( 'Done! Moving to next step…', 'burst-mainwp' ) :
				...
				<div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: 6, paddingTop: 10, borderTop: `1px solid ${border}` }}>
					<button
						...
						title={ __( 'Previous feature', 'burst-mainwp' ) }
						aria-label={ __( 'Previous feature', 'burst-mainwp' ) }
						style={{
							display: 'inline-flex',
							alignItems: 'center',
					...
					{ canSkipFeature && (
						<button
							...
							title={ __( 'Skip feature', 'burst-mainwp' ) }
							aria-label={ __( 'Skip feature', 'burst-mainwp' ) }
							style={{
								display: 'inline-flex',
								alignItems: 'center',
								justifyContent: 'center',
