...
const activationConfigs: Record<string, ActivationConfig> = {
	search_console: {
		...
		disabled: {
			message: __( 'To view your Google searches, enable the Search Console integration.', 'burst-mainwp' ),
			cta: __( 'Enable Search Console', 'burst-mainwp' )
		},
		disconnected: {
			message: __( 'To view your Google searches, connect the Search Console integration.', 'burst-mainwp' ),
			cta: __( 'Connect Search Console', 'burst-mainwp' )
		},
		viewer: __( 'Ask an administrator to connect Google Search Console to see your Google searches here.', 'burst-mainwp' )
	}
};
