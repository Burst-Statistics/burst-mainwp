...
export function SalesChartBlock(): JSX.Element {
	...
	const legendItems = buildForecastLegendItems(
		isRevenueMode ? __( 'Revenue', 'burst-mainwp' ) : __( 'Sales', 'burst-mainwp' ),
		showComparison,
		comparisonLabel,
		showForecast
	);
			...
			<BlockHeading
				title={
					<MetricInfo metricKey="sales_forecast_chart" side="bottom">
						{ isRevenueMode ? __( 'Revenue over time', 'burst-mainwp' ) : __( 'Sales over time', 'burst-mainwp' ) }
					</MetricInfo>
				}
						...
						<div className="flex items-center gap-4 flex-wrap justify-end">
							...
							<div className="flex items-center gap-2">
								...
								{ hasChartData && (
									<ForecastToggle
										active={ showForecast }
										label={ __( 'Forecast', 'burst-mainwp' ) }
