...
export const SearchQueriesOverlay = ({
	...
	<OverlayBlock
		title={ __( 'Search queries', 'burst-mainwp' ) }
		blurLabel={ __( 'Search queries', 'burst-mainwp' ) }
		className={ className }
	>
...
export const SearchQueriesPropertyState = ({
	...
	const message = 'none' === propertyStatus ?
		__( 'No Search Console property matches this site URL.', 'burst-mainwp' ) :
		__( 'Checking your Google Search Console properties…', 'burst-mainwp' );

	return (
		<Block className={ className }>
			<BlockHeading title={ __( 'Search queries', 'burst-mainwp' ) } />
