...
export const getFlowTypeLabel = ( type: FlowNodeType ): string => {
	const labels: Record<FlowNodeType, string> = {
		campaign: __( 'Campaign', 'burst-mainwp' ),
		referrer: __( 'Referrer', 'burst-mainwp' ),
		search: __( 'Search', 'burst-mainwp' ),
		direct: __( 'Direct', 'burst-mainwp' ),
		internal: __( 'Internal page', 'burst-mainwp' ),
		converting: __( 'Converting step', 'burst-mainwp' ),
		exit: __( 'Exit', 'burst-mainwp' ),
		page: __( 'This page', 'burst-mainwp' ),
...
export const getFlowLegendItems = (): Array<{
	...
	{
		id: 'referrer-search',
		label: __( 'Referrer / search', 'burst-mainwp' ),
	...
	{
		id: 'internal',
		label: __( 'Internal page', 'burst-mainwp' ),
	...
	{
		id: 'converting',
		label: __( 'Converting step', 'burst-mainwp' ),
